...
#part of understanding this algorithm is the marching_paren is that we pop the last elment
#off the stack to see whether it has a corresponding matching paren.
